  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4">
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        <Link href='/product/1' className="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" className="object-cover object-center w-full h-full block" src="https://fabcurate.com/cdn/shop/products/32000304-A.jpg?v=1696678413&width=1426/420x260"/>
        </Link>
        <div className="mt-4">
